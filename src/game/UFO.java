...
public class UFO extends GameObject {
	...
	public UFO(int radius, ArrayList<GameObject> neighbours){
        ...
        objectReset();
        try {
        	images[0] = ImageIO.read(new File("./ufoPics/ufo1.png"));
        	images[1] = ImageIO.read(new File("./ufoPics/ufo2.png"));
        	images[2] = ImageIO.read(new File("./ufoPics/ufo3.png"));
        	images[3] = ImageIO.read(new File("./ufoPics/ufo4.png"));
        	images[4] = ImageIO.read(new File("./ufoPics/ufo5.png"));
        }
        catch(IOException e) {
        	e.printStackTrace();        	
        }
	...
	public UFO(Vector2D position, int radius, ArrayList<GameObject> neighbours) {
